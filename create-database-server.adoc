...
+
--
或者，您也可以使用 Codebox 複製空範本或建立完整的範本，以便使用 REST API ， AWS CLI 和 AWS Forgation 在工作負載工廠以外部署資料庫。link:https://docs.netapp.com/us-en/workload-setup-admin/codebox-automation.html["深入瞭解 CodeBox 自動化"^]。
