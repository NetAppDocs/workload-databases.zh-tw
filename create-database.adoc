...
* *憑證和權限*：您必須具備 link:https://docs.netapp.com/us-en/workload-setup-admin/add-credentials.html["AWS 帳戶憑證和 _operations and remediation_ 權限"^] 才能在 Workload Factory 中建立新資料庫。
+
